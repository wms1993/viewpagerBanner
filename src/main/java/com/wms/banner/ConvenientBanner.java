...
import com.wms.banner.adapter.CBPageAdapter;
import com.wms.banner.holder.CBViewHolderCreator;
import com.wms.banner.listener.CBPageChangeListener;
import com.wms.banner.listener.OnItemClickListener;
import com.wms.banner.view.CBLoopViewPager;
...
public class ConvenientBanner<T> extends LinearLayout {
    ...
    private int mLeftPadding = dip2px(5);
    private int mRightPadding = dip2px(5);
    private int pointViewSize = 0;
    ...
    public ConvenientBanner setPageIndicator(int[] page_indicatorId) {
        ...
        for (int count = 0; count < mDatas.size(); count++) {
            ...
            pointView.setPadding(mLeftPadding, 0, mRightPadding, 0);

            if (pointViewSize != 0) {
                ViewGroup.LayoutParams layoutParams = new ViewGroup.LayoutParams(pointViewSize, pointViewSize);
    ...
    public ConvenientBanner setLeftPadding(int leftPadding) {
        this.mLeftPadding = dip2px(leftPadding);
        return this;
    }

    public ConvenientBanner setRightPadding(int rightPadding) {
        this.mRightPadding = dip2px(rightPadding);
        return this;
    }

    public ConvenientBanner setPageIndicatorSize(int size) {
        this.pointViewSize = dip2px(size);
        return this;
    }
